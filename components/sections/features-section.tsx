        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`relative p-8 rounded-2xl ${feature.cardClass} border border-border hover:border-primary/50 transition-all duration-500 hover:shadow-2xl overflow-hidden backdrop-blur-sm`}
                >
                  <div className="relative">
                    <motion.div
                      whileHover={{ rotate: 360, scale: 1.1 }}
                      transition={{ duration: 0.6 }}
                      className="w-16 h-16 rounded-xl bg-primary/20 flex items-center justify-center mb-6 shadow-lg group-hover:shadow-primary/50"
                    >
